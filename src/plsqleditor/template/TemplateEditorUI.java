...
public class TemplateEditorUI
{
    ...
    public TemplateStore getTemplateStore()
    {
        ...
        {
            myTemplateStore = new ContributionTemplateStore(getContextTypeRegistry(), PlsqleditorPlugin
            ...
            {
                PlsqleditorPlugin.getDefault().getLog().log(new Status(IStatus.ERROR,
                        "plsqleditor.editors.PlSqlEditor", IStatus.OK, "", e)); 
            }
        }
