 ...
 * 
 */
public class PlsqlPairMatcher implements ICharacterPairMatcher
{
	...
	public PlsqlPairMatcher(ILog log)
    {
        this.log = log;
	}
        ...
        catch (BadLocationException e)
        {
            ...
            log.log(
                new Status(Status.ERROR,
                    ...
                    "in plug-in " + PlsqleditorPlugin.getPluginId(),
                    e));
        }
		return false;
	}
        ...
        throws BadLocationException
    {
        ...
        String partitionType = PlSqlPartitionScanner.getPlsqlPartition(document, i).getType();
    ...
    {
        return
            partitionType.indexOf(PlSqlPartitionScanner.LITERAL1) != -1 ||
            partitionType.indexOf(PlSqlPartitionScanner.LITERAL2) != -1 ||
            partitionType.indexOf(PlSqlPartitionScanner.COMMENT) != -1;
    }
        ...
        String partitionType) throws BadLocationException
    {
        ...
        {
            if (!PlSqlPartitionScanner.getPlsqlPartition(document, i).getType().equals(partitionType))
            {
        ...
        {
            ITypedRegion partition = PlSqlPartitionScanner.getPlsqlPartition(document, i);
