...
public final class AnnotationType
{
	...
	{
		if (this == ALL) return "AnnotationType.ALL"; //$NON-NLS-1$

		if (this == UNKNOWN) return "AnnotationType.UNKNOWN"; //$NON-NLS-1$

		if (this == BOOKMARK) return "AnnotationType.BOOKMARK"; //$NON-NLS-1$

		if (this == TASK) return "AnnotationType.TASK"; //$NON-NLS-1$

		if (this == ERROR) return "AnnotationType.ERROR"; //$NON-NLS-1$

		if (this == WARNING) return "AnnotationType.WARNING"; //$NON-NLS-1$

		if (this == SEARCH) return "AnnotationType.SEARCH"; //$NON-NLS-1$
		if (this == OCCURRENCE) return "AnnotationType.OCCURRENCE"; //$NON-NLS-1$
