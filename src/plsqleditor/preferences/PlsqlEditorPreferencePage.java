...
public class PlsqlEditorPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    public final OverlayPreferenceStore.OverlayKey[] fKeys = new OverlayPreferenceStore.OverlayKey[] {
	    ...
	    // Appearance Tab
	    // -------------------------------------
	    new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.INT, PreferenceConstants.P_EDITOR_TAB_WIDTH),
...
//					PreferenceConstants.EDITOR_BACKGROUND_DEFAULT_COLOR),
	    ...
	    new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.STRING, PreferenceConstants.P_STRING_COLOUR),
	    new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.BOOLEAN,
		    PreferenceConstants.P_STRING_COLOUR_BOLD),
	    new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.STRING, PreferenceConstants.P_KEYWORD_COLOUR),
	    new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.BOOLEAN,
		    PreferenceConstants.P_KEYWORD_COLOUR_BOLD),
	    new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.STRING, PreferenceConstants.P_COMMENT_COLOUR),
	    new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.BOOLEAN,
		    PreferenceConstants.P_COMMENT_COLOUR_BOLD),
	    new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.STRING, PreferenceConstants.P_TYPE_COLOUR),
	    new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.BOOLEAN,
		    PreferenceConstants.P_TYPE_COLOUR_BOLD),
	    new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.STRING, PreferenceConstants.P_CONSTANT_COLOUR),
	    new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.BOOLEAN,
		    PreferenceConstants.P_CONSTANT_COLOUR_BOLD),
	    new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.STRING, PreferenceConstants.P_OPERATOR_COLOUR),
	    new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.BOOLEAN,
	    ...
	    new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.STRING, PreferenceConstants.P_JAVADOC_COLOUR),
	    new OverlayPreferenceStore.OverlayKey(OverlayPreferenceStore.BOOLEAN,
...
//					PreferenceConstants.EDITOR_FOREGROUND_COLOR },
	    { PreferencesMessages.keywordColor, PreferenceConstants.P_KEYWORD_COLOUR },
	    { PreferencesMessages.stringColor, PreferenceConstants.P_STRING_COLOUR },
	    { PreferencesMessages.typeColor, PreferenceConstants.P_TYPE_COLOUR },
	    { PreferencesMessages.commentsColor, PreferenceConstants.P_COMMENT_COLOUR },
	    { PreferencesMessages.constantsColor, PreferenceConstants.P_CONSTANT_COLOUR },
	    { PreferencesMessages.defaultCodeColor, PreferenceConstants.P_DEFAULT_CODE_COLOUR },
	    { PreferencesMessages.javaDocColor, PreferenceConstants.P_JAVADOC_COLOUR },
	    { PreferencesMessages.builtInFuncsColor, PreferenceConstants.P_BUILT_IN_FUNCS_COLOUR },
	    { PreferencesMessages.operatorColor, PreferenceConstants.P_OPERATOR_COLOUR }, };
	...
	final IPreferenceStore chainedStore = new ChainedPreferenceStore(
		new IPreferenceStore[] { EditorsUI.getPreferenceStore(), getPreferenceStore(), });
	...
	IDocumentPartitioner partitioner = PlSqlPartitionScanner.createPartitioner(document);
	((IDocumentExtension3) document).setDocumentPartitioner(PlsqleditorPlugin.PLSQL_PARTITIONING, partitioner);
	...
	chainedStore.addPropertyChangeListener(new IPropertyChangeListener() {
		...
		fPreviewViewer.getTextWidget().setForeground(
			PlsqleditorPlugin.getDefault().getColor(PreferenceConstants.EDITOR_FOREGROUND_COLOR));
     ...
     * @param store  the preference store from which to read colors
     */
	...
	// ---------- background color ----------------------
	Color color = store.getBoolean(PreferenceConstants.EDITOR_BACKGROUND_DEFAULT_COLOR) ? null
		: createColor(store, PreferenceConstants.P_BACKGROUND_COLOUR, styledText.getDisplay());
	...
	addTextField(appearanceComposite, PreferencesMessages.displayedTabWidth, PreferenceConstants.P_EDITOR_TAB_WIDTH,
		4, 0, true);
	...
	addCheckBox(appearanceComposite, PreferencesMessages.wrapLines, PreferenceConstants.EDITOR_LINE_WRAP, 0);
	...
	addCheckBox(typingComposite, PreferencesMessages.smartHomeEnd, PreferenceConstants.EDITOR_SMART_HOME_END, 0);
    ...
    private Text addTextField(Composite composite, String label, String key, int textLimit, int indentation,
	    boolean isNumber) {
