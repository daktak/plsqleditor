...
public class MultiTableViewer extends StructuredViewer {
    /**
     * TableColorAndFontCollector is an helper class for color and font support for
     * tables that support the ITableFontProvider and the ITableColorProvider.
     * 
    ...
    /**
     * Adds the given elements to this table viewer. If this viewer does not have a
     ...
     * sorter, the element is added at the end; otherwise the element is inserted at
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.jface.viewers.StructuredViewer#doUpdateItem(org.eclipse.swt.
    ...
    /**
     * The table viewer implementation of this <code>Viewer</code> framework method
     * returns the label provider, which in the case of table viewers will be an
     * instance of either <code>ITableLabelProvider</code> or
     * <code>ILabelProvider</code>. If it is an <code>ITableLabelProvider</code>,
     * then it provides a separate label text and image for each column. If it is an
     * <code>ILabelProvider</code>, then it provides only the label text and image
     * for the first column, and any remaining columns are blank.
     */
     ...
     * 
     * @see
     * org.eclipse.jface.viewers.ContentViewer#hookControl(org.eclipse.swt.widgets.
     * Control)
     */
     ...
     * this viewer has a sorter, the position is ignored and the element is inserted
    ...
    /**
     * Refresh all of the elements of the table. update the labels if updatLabels is
     * true;
     * 
     * @param updateLabels
     */
    ...
    /**
     * Removes the given element from this table viewer. The selection is updated if
     * necessary.
     * <p>
     * This method should be called (by the content provider) when a single element
    ...
    /**
     * The table viewer implementation of this <code>Viewer</code> framework method
     * ensures that the given label provider is an instance of either
     * <code>ITableLabelProvider</code> or <code>ILabelProvider</code>. If it is an
     * <code>ITableLabelProvider</code>, then it provides a separate label text and
     * image for each column. If it is an <code>ILabelProvider</code>, then it
    ...
    /**
     * Replace the entries starting at index with elements. This method assumes all
     * of these values are correct and will not call the content provider to verify.
     * <strong>Note that this method will create a TableItem for all of the elements
     * provided</strong>.
     * 
     * @param element The element you are placing in the specified
     *                <code>index</code>.
     * 
     * @param index   The location of the item you are replacing.
     * 
    ...
    /**
     * This method gets the name that should be supplied on each tab. <br/>
     * This is truncated if the supplied <code>fullQuery</code> is too long.
     * 
     * @param fullQuery The full sql statement.
     * 
     * @return The truncated query for use as the name of a tab in the scratch
     *         output.
     */
	...
	if (source instanceof String) {
	    ...
	    Text widgetText = new Text(myResultTablesFolder,
	    ...
	    Table resultSetTable = new Table(myResultTablesFolder,
	...
	SortableTableTest.addSortListeners(table, null, new ItemCreator() {
