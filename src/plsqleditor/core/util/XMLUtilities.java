				...
				while (iter.hasNext())
				{
					...
					if (replaceVariables)
					{
						try
						{
							...
							// for
							// our purposes, as it only works in context of a
							// selected
							// resource (see ResourceResolver.java:40); however,
							// we don't guarantee that there is any resource
							// selected,
							// leading to exceptions (or the selected resource
							// may
							// be something accidental, leading to erratic
							// behaviour)
