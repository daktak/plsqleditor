 ...
 * </p>
 */
public class LiveConnectionComparator extends ViewerComparator {
     ...
     *                 <code>TYPE</code>
     */
    public LiveConnectionComparator(int criteria) {
	super();
    ...
    /**
     * Returns a number reflecting the collation order of the given tasks based on
