...
public class TestSequentialLoopingParserSpecification extends TestCase
{
    public void testParseToken_EqualsB_NoOptional_NoMulti()
    {
        ...
        SequentialCompositeParseSpecification scps = new SequentialCompositeParseSpecification("EqualsB");
    ...
    public void testParseToken_AEqualsCommaSeparatedListEndDelimited()
    {
        ...
        SequentialCompositeParseSpecification main = new SequentialCompositeParseSpecification("Main");
        SequentialCompositeParseSpecification commaList = new SequentialCompositeParseSpecification("CommaList");
    ...
    public void testParseToken_AEqualsCommaSeparatedList()
    {
        StringInput si1 = new StringInput("A := B,C,D,E");
        StringInput si2 = new StringInput("A := B,C");
        StringInput si3 = new StringInput("A := B");
        StringInput siBadButNoFail = new StringInput("A := B,");
        DelimiterSpec assignTo = new DelimiterSpec("AssignTo", ":=", true);
        DelimiterSpec comma = new DelimiterSpec("Comma", ",", true);
        SimpleParseSpecification ssp = new SimpleParseSpecification("Variable");
        ...
        try
        {
            IParseResult result = main.parse(curPos, endPos, siBadButNoFail);
            assertEquals(0, result.getStartPosition().getOffset());
            String expected = "A := B";
            assertEquals(expected.length() - 1, result.getEndPosition().getOffset());
