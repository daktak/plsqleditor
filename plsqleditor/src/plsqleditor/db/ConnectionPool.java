...
/**
 * Creates a pool of database connections and returns them as needed.
 * This class handles preallocating, recycling, and managing JDBC connections.
 */
...
public class ConnectionPool implements Runnable
{
    ...
    private final static String CONNECTION_LIMIT_ERR_MSG =
        "Connection limit reached";
    private final static String DRIVER_CLASS_NOT_FOUND_ERR_MSG =
