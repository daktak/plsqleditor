 ...
 */
public class MultiPagePlsqlEditorContributor extends MultiPageEditorActionBarContributor
{
    ...
    private void createActions()
    {
        runPlDocAction = new Action()
        {
            public void run()
            {
                ...
                MessageDialog.openInformation(null, "Generate Pldoc", "Documentation generated");
            }
        };
