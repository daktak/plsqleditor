...
public class PlSqlCodeScanner extends RuleBasedScanner
{
    public PlSqlCodeScanner(ColorManager provider)
    {
        ...
        IToken sqlkeyword = new Token(new ConfigurableTextAttribute(PreferenceConstants.P_KEYWORD_COLOUR,PreferenceConstants.P_BACKGROUND_COLOUR,1));
        IToken operator = new Token(new ConfigurableTextAttribute(PreferenceConstants.P_OPERATOR_COLOUR,PreferenceConstants.P_BACKGROUND_COLOUR,0));
        IToken type = new Token(new ConfigurableTextAttribute(PreferenceConstants.P_TYPE_COLOUR,PreferenceConstants.P_BACKGROUND_COLOUR,0));
        IToken constants = new Token(new ConfigurableTextAttribute(PreferenceConstants.P_CONSTANT_COLOUR,PreferenceConstants.P_BACKGROUND_COLOUR,0));
        IToken string = new Token(new ConfigurableTextAttribute(PreferenceConstants.P_STRING_COLOUR,PreferenceConstants.P_BACKGROUND_COLOUR,0));
        IToken comment = new Token(new ConfigurableTextAttribute(PreferenceConstants.P_COMMENT_COLOUR,PreferenceConstants.P_BACKGROUND_COLOUR,0));
    ...
    protected static final String DATATYPES[] = {
    ...
    protected static final String KEYWORDS[] = {
        ...
        "NOWAIT", "NUMERIC", "OBJECT", "OF", "OFF", "OFFLINE", "OID", "OIDINDEX", "OLD", 
        ...
        "DIGITS", "DISPOSE", "DO", "ELSE", "ELSIF", "EXCEPTION_INIT", "FETCH", "FOR", "FORM", 
        "GENERIC", "GOTO", "IF", "INTERFACE", "LIMITED", "LOOP", "NEXTVAL", "PRAGMA", "RAISE", "RECORD", 
        "RELEASE", "ROWTYPE", "SIGNTYPE", "SPACE", "SQL", "STATEMENT", "SUBTYPE", "TASK", "TERMINATE",
        "VIEWS", "WHILE"
    };
