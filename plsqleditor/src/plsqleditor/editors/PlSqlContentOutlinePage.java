...
public class PlSqlContentOutlinePage extends ContentOutlinePage
{
	 ...
	 */
	public class PlSqlContentLabelProvider extends LabelProvider implements
			IBaseLabelProvider
	{
		/**
		 * @param display
		...
		public Image getImage(Object element)
		{
			if (element instanceof Segment)
			{
				...
				return PlsqleditorPlugin.getDefault().getImageRegistry().get(
						key);
			}
			return null;
		}
	...
	class ContentProvider implements ITreeContentProvider
	{
		...
		{
			mySegments.addAll(sortAndFilterSegments(f.getSegments(), f
					.getDocument()));
		}
				...
				try
				{
					if (segment.getType() != SegmentType.Code)
					{
						...
						if (segment instanceof PackageSegment)
						{
							...
							PackageSegment clone = (PackageSegment) pkgSegment
									.clone();
							List containedSegments = clone
									.getContainedSegments();
							List sortedContainedSegments = sortAndFilterSegments(
									clone.getContainedSegments(), document);
	...
	public PlSqlContentOutlinePage(IDocumentProvider provider,
			ITextEditor editor)
	{
		fTextEditor = editor;
	}
	...
	public void createControl(Composite parent)
	{
		...
		viewer.setLabelProvider(new PlSqlContentLabelProvider(viewer
		...
		myFieldFilter = new ViewerFilter()
		{
					...
					Object element)
			{
				if (element instanceof Segment)
				{
					...
					return (st.equals(SegmentType.Package_Body)
							|| st.equals(SegmentType.Procedure) || st
	...
	public void createActions()
	{
		...
		sortAction.setImageDescriptor(PlsqleditorPlugin
				.getImageDescriptor("sort.gif"));
		...
		filterFieldsAction.setImageDescriptor(PlsqleditorPlugin
